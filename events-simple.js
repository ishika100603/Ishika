(function() {
  ...
  d3.csv('synthetic-data.csv').then(function(data) {
    ...
    const colorScale = d3.scaleOrdinal()
      .domain(['Renaissance', 'Baroque', 'Impressionist', 'Post-Impressionist', 'Modern', 'Contemporary'])
      .range(['#d4a24c', '#8b3a3a', '#6b9cff', '#ff6b6b', '#ffcc66', '#9edb8d']);
    ...
    svg.append('text')
      ...
      .text('History of Painting Technique: Renaissance to Contemporary');
  }).catch(function() {
